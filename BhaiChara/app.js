...
// ─────────────────────────────────────────────────────────
//  📱 PHONE OTP LOGIN — TextBee SMS Integration
// ─────────────────────────────────────────────────────────
...
window.sendPhoneOtp = async function() {
  ...
  try {
    ...
    // Step 2: Vercel API se real SMS OTP bhejwao
...
window.verifyPhoneOtp = async function() {
  ...
  if (!enteredOtp || enteredOtp.length !== 6) {
    showToast("6 digit OTP dalo bhai!"); return;
  }
  ...
  try {
    // Vercel API se OTP verify karwao
    ...
    // ✅ OTP sahi — Firebase login logic same rehta hai
    const uidSnap = await get(ref(db, `phone_index/${phone}`));
