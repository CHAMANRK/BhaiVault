...
function showLoginScreen() {
  ...
  // BUGFIX: pehle sirf hideLoginScreen() (logged-in path) hidePageLoader()
  // call karta tha — logged-out/naya-visitor path pe loader kabhi hide hi
  // nahi hota tha, isliye #page-loader (z-index 9999) login screen ke upar
  // hamesha chhaya rehta tha aur app "loading pe atka" dikhta tha.
  hidePageLoader();
}
